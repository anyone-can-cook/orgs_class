...
- Office hours:
  - Mondays 3-4pm, and by appointment (afternoons)
...
Organizational theory draws from multiple disciplines (e.g., sociology, psychology, economics, political science) and each discipline approaches organizational behavior from a different perspective and with a different focus.
...
1. **Lecture**. Lecture (hopefully 60 minutes or less) will focus on core ideas from reading as well as contextual information to help you understand the required readings better. The [course website](https://anyone-can-cook.github.io/orgs_class/) will have lecture slides and -- when available -- video lectures from prior years. During class, the instructor will tailor lecture to the questions/comments posed by students prior to class. 

2. **Class discussion/activities**. What we will vary from week to week. Generally there will be a student-led activity/discussion around the topic of the week. In many weeks, there will be activity/discussion by the instructor that focuses on applying theory to research, and also time for discussion about the reading.
...
If you have a personal question or issue, email the instructor directly [ozanj@ucla.edu](ozanj@ucla.edu).
...
INCLUDE OPPOSITIONAL READINGS; REPLACE CERTAIN ORG THEORY PERSPECTIVES WITH PERSPECTIVES THAT ARE MORE CRITICAL.
