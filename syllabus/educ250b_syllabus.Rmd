...
This course will cover a new topic each week. Class will consist of weekly synchronous lectures on Wednesdays from 8:30AM to 10AM and an asynchronous component to be completed before the live class.
...
**Student-led discussion of one required reading** (15%)
...
- The goal of these activities is to move beyond simply learning theory to envisioning how these frameworks emerge in higher education as well as other organizational structures. Class activities should complement the course lectures and readings as well as engage other organizational theories that we will be learning throughout the quarter.
