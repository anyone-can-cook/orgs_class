...
l <- c("https://anyone-can-cook.github.io/orgs_class/", "Wednesdays, 9AM-11:50AM", "Moore 3030", "https://ucla.zoom.us/j/2545750562")
...
1. **Lecture**. Lecture will focus on core ideas from reading as well as contextual information to help you understand the required readings better. The [course website](https://anyone-can-cook.github.io/orgs_class/) will have lecture slides and -- when available -- video lectures from prior years. During class, the instructor will try to tailor lecture to the questions/comments posed by students prior to class. 
1. **Student-led discussion**. Each week there will be a student led discussion about the readings that will typically last anywhere from 45 - 75 minutes. 
...
1. **Other**. What we do in time that remains will vary from week to week. In latter half of the course we will focus on learning to apply organizational theory to research questions of your choosing.
...
- Pfeffer, Jeffre, & Salancik, Gerald R. (1978). _The external control of organizations: A resource dependence perspective_. New York: Harper & Row.
- Chun, Wendy H.K. (2021). _Discriminating data: Correlation, neighborhoods, and the new politics of recognition_. The MIT Press. 
...
**Student-led activity for theory application** (5%)
