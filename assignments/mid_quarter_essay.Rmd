...
- *Note: This above essay prompt has been slightly revised. By clicking below, you can see the original essay prompt. Your essay can address either the original or the revised prompt.*

<br>

<details><summary>**Click to view original essay prompt"**</summary> 

The "Combahee River Collective" was a Black feminist organization best known for publishing the 1977 _Combahee River Collective Statement_, which became an important document in the development of Black feminism [@RN4570]. @RN869 develop an old institutionalism analysis of the origins and institutionalization of the "terminal vocational education" mission of the community college. Your task is, first, to develop an old institutionalism analysis of the origins and institutionalization of the _Combahee River Collective Statement_. Next, how do the limitations of old institutionalism as a theoretical perspective undermine this analysis? And how can selected ideas/concepts from Black feminism -- from _Combahee River Collective Statement_ or other Black feminist scholarship you have read -- be incorporated to develop a more insightful analysis about the origins of the  _Combahee River Collective Statement_ and/or explanation for why this statement has been so impactful?
...
- For this essay (also essays prompts I write for take-home final and DAP exam; also, when I am a reviewer for journal manuscripts) I want you to do three basic things in some order: define theory; introduce empirical context of the case; apply theory to the case
  - define theory and key concepts of theory
    - includes brief, broad overview of theory you are using
    - define the key concepts of the theory that you will apply to the case
  ...
  - apply theory/concepts to the case
    - start w/ general concept from the theory; show how some aspect of the case can be thought of as a specific example of the general concept from the theory
    - hopefully, explaining the case in terms of concepts from theory leads to insights about the case
- Don't feel compelled to delve deeply into both the origins and institutionalization of _Combahee River Collective Statement_; fine to devote more attention to one more than the other
- On old institutionalism
  ...
  - Note that there are different “flavors” of old institutionalism. These different flavors share some common ideas/approaches that are fundamental to old institutionalism, but differ in other ways. You can be selective about which “flavor” of old institutionalism you draw from (but choose the flavor that you think is best for this analysis). Also, given space limitations, be purposeful about which concepts you choose to introduce.
