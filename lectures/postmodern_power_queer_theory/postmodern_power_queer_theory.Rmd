...
- Disciplines, professional societies "turn" from one set of assumptions/beliefs to another, often because an organized coalition of actors engage in a successful coup of the dominant canon
  - the new discourse was motivated by a critique of the domination/violence from the previously ascendant discourse, - For Foucault, the replacing of one discourse is neither good nor bad
...
- Normativity and self-regulation
  ...
  - Not only do people stop defying these definitions of normality, it defiance does not occur to them because they have internalized the socially constructed logic of the discourse as self-evident, universal truth
...
- Intersectionality is focuses on oppression that results from  belonging to the oppressed group in multiple categories of social identity
