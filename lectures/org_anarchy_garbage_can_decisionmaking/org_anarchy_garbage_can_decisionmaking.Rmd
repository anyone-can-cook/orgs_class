...
Example choice opportunity: who teaches required undergrad methods courses

- Problem
    - Undergrad major plan approved by Academic Senate proposed 2-3 basic methods courses undergrads must complete
    - But not a lot of faculty interested in teaching "inquiry" (i.e., methods) courses
- Solution
    - Require all faculty to teach 1 undergrad course; convince some to teach methods
- Participants (Ozan)
    - Ozan could teach intro stats or other quant methods courses
    - But Ozan is a crazy zealot who only cares about reforming graduate methods training and developing a "data science using R" sequence
        - He views this as "solution" to "problem" of improving research training for grad students
    - Wants to teach his "intro to programming using R" course as undergrad elective
- Garbage can
    - Simple choice opportunity of who teaches intro stats course becomes complicated because other participants attach their problems/solutions to this choice
...
- Common when an administrator can push things through via "executive order"; usually not possible for decisions that require vote or formal approval by multiple parties
